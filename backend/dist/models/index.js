...
// Turno 1:N Trabajador
turno_1.Turno.hasMany(trabajador_1.Trabajador, { foreignKey: 'turnoId' });
trabajador_1.Trabajador.belongsTo(turno_1.Turno, { foreignKey: 'turnoId' });
